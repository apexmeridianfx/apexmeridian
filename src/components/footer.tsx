        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-8 lg:mb-0">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              Your trusted partner for professional forex trading, real estate investment, and business financing solutions.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground text-center md:text-left">
              © {new Date().getFullYear()} Apex Meridian Financial Services. All rights reserved.
            </p>
            <p className="text-xs text-muted-foreground text-center md:text-right max-w-lg">
              Investment products are not insured by any government agency. Past performance does not guarantee future results. Please read all disclosures carefully before investing.
            </p>
          </div>
        </div>
      </div>
